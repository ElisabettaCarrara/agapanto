 ...
 */
class Agapanto_Portfolio_Vertical_Box_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        // Setup Widget.
        parent::__construct(
            'agapanto-portfolio-vertical-box', // ID.
            esc_html__('Portfolio (Vertical Box)', 'agapanto'), // Name.
            array(
                'classname'                   => 'agapanto-portfolio-vertical-box-widget',
                'description'                 => esc_html__('Displays your posts from a selected category in a vertical box.', 'agapanto'),
    ...
    {
        $defaults = array(
            'title'    => esc_html__('Portfolio (Vertical Box)', 'agapanto'),
            'category' => 0,
        );
...
?>
        ...
        <div class="widget-portfolio-posts-vertical-box widget-portfolio-posts clearfix">
            ...
            <div class="widget-portfolio-posts-content portfolio-vertical-box clearfix">
     ...
     *
     * @uses this->portfolio_posts_vertical() or this->portfolio_posts_vertical()
     * @used-by this->widget()
     *
    ...
    {
        // Get cached post ids.
        $post_ids = agapanto_get_portfolio_post_ids($this->id, $settings['category'], 5);
        ...
        if ($posts_query->have_posts()) :
            ...
            while ($posts_query->have_posts()) :
                ...
                if (0 === $posts_query->current_post) :
                    get_template_part('template-parts/widgets/portfolio-large-post', 'vertical-box');
                    echo '<div class="small-posts clearfix">';
                else :
                    get_template_part('template-parts/widgets/portfolio-small-post', 'vertical-box');
                endif;
 ...
 * Register Widget
 */
function agapanto_register_portfolio_posts_vertical_box_widget()
{
    register_widget('Agapanto_Portfolio_Vertical_Box_Widget');
}
add_action('widgets_init', 'agapanto_register_portfolio_posts_vertical_box_widget');
