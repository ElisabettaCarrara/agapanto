 ...
 */
class Agapanto_Magazine_Horizontal_Box_Widget extends WP_Widget {
	...
	public function __construct() {
		// Setup Widget.
		parent::__construct(
			'agapanto-magazine-posts-boxed', // ID.
			esc_html__( 'Magazine (Horizontal Box)', 'agapanto' ), // Name.
			array(
				'classname'                   => 'agapanto-magazine-horizontal-box-widget',
	...
	private function default_settings() {
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Horizontal Box)', 'agapanto' ),
			'category' => 0,
		);
	...
	public function render( $settings ) {
		// Get cached post ids.
		$post_ids = agapanto_get_magazine_post_ids( $this->id, $settings['category'], 4 );
 ...
 * Register Widget
 */
function agapanto_register_magazine_posts_horizontal_box_widget() {
	register_widget( 'Agapanto_Magazine_Horizontal_Box_Widget' );
}
add_action( 'widgets_init', 'agapanto_register_magazine_posts_horizontal_box_widget' );
