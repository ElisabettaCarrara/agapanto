 ...
 */
class Agapanto_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Vertical Box)', 'agapanto' ), // Name.
			array(
				'classname'                   => 'agapanto-magazine-vertical-box-widget',
