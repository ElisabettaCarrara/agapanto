 ...
 */
class Agapanto_Magazine_Posts_Columns_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'agapanto-magazine-posts-columns', // ID.
			esc_html__( 'Magazine (Columns)', 'agapanto' ), // Name.
			array(
				'classname'                   => 'agapanto-magazine-columns-widget',
