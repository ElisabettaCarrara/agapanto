 ...
 */
function agapanto_slider_scripts() {

	// Get theme options from database.
	$theme_options = agapanto_theme_options();

	// Register and enqueue FlexSlider JS and CSS if necessary.
	if ( ( true === $theme_options['slider_blog'] or true === $theme_options['slider_magazine'] or is_page_template( 'template-slider.php' ) ) && ! agapanto_is_amp() ) :
		...
		wp_enqueue_script( 'agapanto-slider', get_template_directory_uri() . '/assets/js/slider.js', array( 'jquery-flexslider' ), '20170421' );

	endif;
}
add_action( 'wp_enqueue_scripts', 'agapanto_slider_scripts' );
 ...
 */
function agapanto_slider_options() {
	...
	wp_localize_script( 'agapanto-slider', 'agapanto_slider_params', $params );

}
add_action( 'wp_enqueue_scripts', 'agapanto_slider_options' );


/**
 * Display Post Slider
 */
function agapanto_slider() {
...
if ( ! function_exists( 'agapanto_slider_excerpt_length' ) ) :
	/**
	 ...
	 * @return int
	 */
	function agapanto_slider_excerpt_length( $length ) {
		return 25;
	}
endif;


if ( ! function_exists( 'agapanto_slider_image' ) ) :
	/**
	 ...
	 */
	function agapanto_slider_image( $size = 'post-thumbnail', $attr = array() ) {
