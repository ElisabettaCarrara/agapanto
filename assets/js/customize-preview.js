...
( function( $ ) {
	...
	// Site Title checkbox.
	wp.customize( 'agapanto_theme_options[site_title]', function( value ) {
	...
	wp.customize( 'agapanto_theme_options[site_description]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Sidebar Position.
	wp.customize( 'agapanto_theme_options[layout]', function( value ) {
		value.bind( function( newval ) {
	...
	// Blog Layout.
	wp.customize( 'agapanto_theme_options[post_layout_archives]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'agapanto_theme_options[latest_posts_title]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'agapanto_theme_options[blog_description]', function( value ) {
		value.bind( function( to ) {
	...
	// Read More textfield.
	wp.customize( 'agapanto_theme_options[read_more_text]', function( value ) {
		value.bind( function( to ) {
			$( 'a.more-link' ).text( to );
		} );
	} );
	...
	// Post Date checkbox.
	wp.customize( 'agapanto_theme_options[meta_date]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'agapanto_theme_options[meta_author]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'agapanto_theme_options[meta_category]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Post Tags checkbox.
	wp.customize( 'agapanto_theme_options[meta_tags]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'agapanto_theme_options[post_navigation]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
